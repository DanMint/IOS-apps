...
class deleteScroll: UIViewController {
    
    var names : [String] = []
    var lastName : [String] = []
    
    @IBOutlet weak var theDeleteScroll: UITableView!
    ...
    override func viewDidLoad() {
        ...
        theDeleteScroll.dataSource = self
        
    }
}

extension deleteScroll : UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return names.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = theDeleteScroll.dequeueReusableCell(withIdentifier: "deleteCell") as! deleteCellMod
